SELECT * FROM benh_ga.benh;

use benh_ga
INSERT INTO benh (ten_benh,dulieubenh)
VALUES (
'Bệnh Gà Rù', 
'1. Bệnh Gà Rù Ở Gà Là Bệnh Gì?
Bệnh gà rù ở gà hay có tên gọi khác là bệnh gà rù, bệnh tân thành gà,… Đây là một bệnh truyền nhiễm do virus gây nên với các triệu chứng như phân xanh, khó thở, dáng đi siêu vẹo,… Bệnh lây lan nhanh chóng, nếu không phát hiện kịp thời có thể gây chết 100% gây thiệt hại lớn cho trang trại chăn nuôi
2.Nguyên nhân gây bệnh gà rù?
Bệnh gà rù do virus Newcastle (NDV) gây ra - một loại virus RNA thuộc họ Paramyxoviridae. Virus này có thể gây bệnh ở hầu hết các loài gia cầm như gà, vịt, ngan, ngỗng, chim cút nhưng gà là đối tượng mẫn cảm nhất. Đặc biệt, virus NDV có sức đề kháng rất cao trong môi trường, tồn tại lâu trong phân, nước, thức ăn, hoặc chất độn chuồng. Nó có thể sống sót hàng tuần trong môi trường ẩm lạnh, khiến việc kiểm soát dịch trở nên khó khăn hơn nhiều.
3.Virus Paramyxovirus là gì?
...
4.Biểu hiện của bệnh gà rù ở gà?
Khi virus xâm nhập vào cơ thể gà, nó tấn công chủ yếu vào đường hô hấp, tiêu hóa và hệ thần kinh trung ương. Thời gian ủ bệnh thường kéo dài 3-5 ngày nhưng trong một số trường hợp có thể chỉ 2 ngày hoặc lâu hơn một tuần. Tùy vào mức độ độc lực của virus, bệnh có thể tiến triển ở ba thể chính: thể quá cấp tính, thể cấp tính và thể mạn tính. 
Thể quá cấp tính ?
Gà ủ rũ, xù lông
...
5.Cách phòng bệnh gà rù ở gà ?
Bệnh gà rù có khả năng lây lan nhanh chóng nên việc phòng bệnh cần được người nuôi thực hiện để đảm bảo đàn gà luôn khỏe mạnh bằng các biện pháp giữ gìn vệ sinh môi trường và tiêm phòng vaccine, bổ sung thuốc bổ nhằm tăng sức đề kháng cho vật nuôi.
Vệ sinh trang trại
...
7.Các loại vắc xin để tiêm cho gà bị bệnh gà rù ?
Vaccine Newcastle Bronchitis: Vaccine sống, có thể cho vào mắt hoặc uống, là loại vaccine nhũ dầu vô hoạt.
...
VALUES (
'Bệnh Cầu Trùng ', 
'1.Bệnh cầu trùng ở gà là bệnh gì?
Bệnh cầu trùng ở gà có tên khoa học là Coccidiosis Avium, là bệnh ký sinh trùng truyền nhiễm xảy ra trên gà, thường bùng phát nhanh khi thời tiết ấm ướt và có tính lan cao, đồng thời tồn tại dài dẳng, khó mà điều trị dứt điểm. Bệnh phổ biến ở giai đoạn gà 2-8 tuần tuổi. Theo một số thống kê cho thấy, tại Việt Nam tỷ lệ gà chết do bị cầu trùng chiếm 5-15% và khi bị mắc cầu trùng gà rất dễ mắc các bệnh truyền nhiễm khác như Gumboro, tụ huyết trùng … do sức đề kháng của gà lúc này rất yếu.
2.Nguyên nhân gây bệnh cầu trùng ở gà?
Nguyên nhân gây bệnh cầu trùng gà xuất phát từ ký sinh trùng đơn bào thuộc giống Eimeria. Có 9 loại cầu trùng gây bệnh gà ký sinh đó là: E.maxima, E.brunetti, E.acervulina, E.tenella, E.praecox, E.mivatis, E.hagani, E.necatrix. Mỗi loại cầu trùng lại kí sinh ở các đoạn khác nhau trong đường tiêu hoá của gà. 2 loại cầu trùng nguy hiểm nhất đó là Necatrix và Tenella kí sinh ở ruột non và manh tràng. 
Nang cầu trùng tồn tại bên ngoài môi trường trong thời gian dài và không dễ dàng bị tiêu diệt. Chính vì thế, khi gà ăn phải thức ăn, nước uống hoặc môi trường sống không sạch sẽ có nhiễm mầm bệnh rất dễ khiến bệnh cầu trùng bùng phát và lây lan. Bên cạnh đó, các loài chim chóc, động vật gặm nhấm, côn trùng, môi trường chăn nuôi không đảm bảo cũng là những nguyên nhân gây ra bệnh này. 
Nang cầu trùng tồn tại bên ngoài môi trường trong thời gian dài và không dễ dàng bị tiêu diệt. 
2.1. Eimeria maxima
Định nghĩa: Là một loại cầu trùng gây bệnh chủ yếu ở phần ruột non của gà.
Lý do gây bệnh: E. maxima tấn công tế bào niêm mạc ruột, làm tổn thương và viêm loét niêm mạc. Điều này dẫn đến việc giảm khả năng hấp thu chất dinh dưỡng, khiến gà bị suy nhược, tiêu chảy và giảm sức đề kháng.
2.2. Eimeria brunetti
Định nghĩa: Là loại cầu trùng gây tổn thương chủ yếu ở đoạn ruột non.
Lý do gây bệnh: E. brunetti xâm nhập vào niêm mạc ruột và phá hủy các tế bào, gây viêm và loét. Điều này làm giảm khả năng tiêu hóa và hấp thu thức ăn của gà, gây ra tình trạng tiêu chảy và thiếu chất dinh dưỡng.
2.3. Eimeria acervulina
Định nghĩa: Loại cầu trùng này chủ yếu gây nhiễm trùng ở phần đầu ruột non.
Lý do gây bệnh: Khi E. acervulina xâm nhập, nó gây tổn thương niêm mạc ruột non, làm giảm khả năng hấp thu dưỡng chất, dẫn đến tình trạng gà còi cọc và kém phát triển.
2.4. Eimeria tenella
Định nghĩa: Là một loại cầu trùng tấn công chủ yếu ở đại tràng.
Lý do gây bệnh: E. tenella gây viêm loét nặng ở đại tràng, làm gà bị tiêu chảy nặng, mất máu và dễ mắc các bệnh nhiễm khuẩn thứ phát, có thể gây tử vong nếu không điều trị kịp thời.
2.5. Eimeria praecox
Định nghĩa: Gây nhiễm ở phần đầu ruột non của gà.
Lý do gây bệnh: E. praecox thường gây tổn thương nhẹ ở gà non, nhưng có thể làm gà giảm trưởng và dễ mắc bệnh khác nếu không được chăm sóc tốt.
2.6. Eimeria mivatis
Định nghĩa: Một loại cầu trùng gây bệnh ở ruột non và đại tràng.
Lý do gây bệnh: E. mivatis phá hủy tế bào niêm mạc ruột, làm gà có biểu hiện tiêu chảy, mất máu và suy giảm sức đề kháng.
2.7. Eimeria hagani
Định nghĩa: Loại cầu trùng này gây bệnh ở ruột non và đại tràng.
Lý do gây bệnh: E. hagani làm tổn thương niêm mạc ruột, ảnh hưởng đến khả năng tiêu hóa và hấp thu dưỡng chất của gà. Gà dễ bị suy dinh dưỡng và tiêu chảy kéo dài.
2.8. Eimeria necatrix
Định nghĩa: Là loại cầu trùng gây nhiễm trùng ở đại tràng và ruột non.
Lý do gây bệnh: E. necatrix có thể gây tổn thương nghiêm trọng ở ruột, dẫn đến tiêu chảy, mất nước và mất máu. Nếu không điều trị, nó có thể làm gà bị tử vong.
Tại sao chúng gây bệnh cho gà?
Cơ chế ký sinh: Cầu trùng xâm nhập vào niêm mạc ruột của gà, làm tổn thương tế bào và gây viêm loét. Những tổn thương này làm giảm khả năng tiêu hóa và hấp thu dinh dưỡng của gà.
Giảm sức đề kháng: Cầu trùng làm suy yếu hệ miễn dịch của gà, khiến chúng dễ bị nhiễm các bệnh khác và giảm sức khỏe chung.
Tiêu chảy và mất nước: Gà mắc bệnh coccidiosis thường xuyên bị tiêu chảy, dẫn đến mất nước và chất điện giải, gây mệt mỏi và giảm năng suất.
Những tác động trên làm giảm khả năng tăng trưởng và sản xuất của gà, thậm chí gây tử vong nếu không được điều trị kịp thời.
3.Biểu hiện / dấu hiệu bệnh cầu trùng ở gà?
...
Ở thể cấp tính gà thường đi ngoài phân có màu vàng hoặc phân có màu nâu đỏ, kế tiếp chuyển sang giai đoạn phân lẫn máu, thậm chí có nhiều trường hợp gà đi ngoài toàn máu.
...
4.Cách phòng bệnh cầu trùng gà?
Áp dụng các biện pháp phòng chống bệnh cấu trùng ở gà là cách để gà không mắc phải bệnh cầu trùng. Bà con cần nắm bắt một số biện pháp đó là:Từ khi là con giống thì bà con nên chọn con giống khoẻ mạnh, không có mầm bệnh. Khi mang con giống về nuôi nên tiêm phòng vaccine để hạn chế bệnh tật. 
Bà con nên mua thức ăn đảm bảo chất lượng và bảo quản thức kỹ lưỡng, tránh bị ẩm mốc. 
Thường xuyên vệ sinh máng ăn, máng uống nước sạch sẽ để không dính mầm bệnh cầu trùng gà. 
Bổ sung thêm các loại men tiêu hoá, vitamin,… để tăng sức đề kháng cho gà. 
Cần để chuồng trại thông thoáng, không để chuồng quá nóng hoặc quá lạnh. Thường xuyên thay lớp độn chuồng mới. 
Xây dựng chuồng trại khang trang, tránh để chuột, rắn, chim chóc lại gần dễ khiến gà mắc bệnh. 
Cần vệ sinh, dọn dẹp chuồng trại sạch sẽ bằng men vi sinh chăn nuôi. Đây là dòng sản phẩm có chứa các vi sinh vật có lợi rất tốt trong việc khử khuẩn, làm sạch môi trường chăn nuôi, rất tốt với vật nuôi và an toàn cho người, môi trường xung quanh. 
5. Cách điều trị bệnh cầu trùng ở gà?
Sau khi đã nắm bắt được nguyên nhân và dấu hiệu bệnh thì bà con cần tìm ra cách chữa trị bệnh cấu trùng gà. Đó là: 
5.1 Sử dụng thuốc thú y chữa bệnh cầu trùng gà
Khi gà mắc bệnh thì bà con có thể sử dụng một số loại thuốc bán ở quầy thú ý như: toltrazuril, diclazuril, amprolium, tetracylin,… Bà con cần tuân thủ hướng dẫn của nhà sản xuất về cách dùng, thời gian sử dụng. Và trong quá trình sử dụng cần lưu ý một số vấn đề dưới đây:
Chỉ sử dụng 1 loại thuốc nhất định và không phối trộn nhiều loại.
Sử dụng thuốc theo liều lượng, liệu trình trong thời gian nhất định. 
Khi gà mắc bệnh bà con cần cầm máu bằng cách sử dụng vitamin K kịp thời kết hợp các loại vitamin tổng hợp để gà tăng sức đề kháng và bệnh mau khỏi. Đối với gà mắc bệnh cần cách ly ở khu vực riêng, tránh lây nhiễm với đàn gà đang khỏe mạnh. 
5.2 Sử dụng phương pháp dân gian
Đối với những người chăn nuôi không muốn lạm dụng thuốc thú y thì bà con có thể tham khảo cách chữa trị dân gian. Bà con cần tìm lá mơ rừng. Mang lá mơ đi rửa sạch và đâm cùng với một ít muối hột chắt lấy nước. Tuỳ vào thể trọng, cân nặng của gà để cho uống từ 1ml và phần xác lá mơ mang đi trộn với thức ăn để cho gà ăn. 
6.Các loại vắc xin để tiêm cho gà bị bệnh cầu trùng  ?
6.1. Vắc-xin Coccivac
Định nghĩa: Đây là một vắc-xin sống, chứa các chủng cầu trùng đã bị làm yếu (attenuated) để tạo ra miễn dịch cho gà.
Công dụng: Vắc-xin này giúp gà phát triển khả năng miễn dịch đối với các loại cầu trùng như Eimeria acervulina, Eimeria maxima, Eimeria tenella và các chủng khác.
6.2. Vắc-xin Coxabac
Định nghĩa: Vắc-xin này cũng là vắc-xin sống chứa các chủng cầu trùng yếu, giúp phòng ngừa bệnh coccidiosis ở gà.
Công dụng: Đây là một trong các vắc-xin phổ biến ở các trại nuôi gà, giúp giảm nguy cơ mắc bệnh và hạn chế sự lây lan trong đàn.
6.3. Vắc-xin Livacox
Định nghĩa: Là vắc-xin sống hoặc chết, giúp bảo vệ gà khỏi bệnh cầu trùng do các chủng Eimeria gây ra.
Công dụng: Vắc-xin này đặc biệt hiệu quả trong việc kiểm soát bệnh ở gà nuôi công nghiệp, giúp tăng sức đề kháng và giảm thiệt hại về kinh tế do bệnh gây ra.
6.4. Vắc-xin Paracox
Định nghĩa: Là vắc-xin sống chứa các chủng cầu trùng đã được làm yếu, được tiêm để phòng ngừa bệnh coccidiosis ở gà.
Công dụng: Vắc-xin này được tiêm vào gà con hoặc gà trưởng thành, giúp bảo vệ gà khỏi các loại cầu trùng gây bệnh trong suốt quá trình phát triển.
6.5. Vắc-xin Coxoid
Định nghĩa: Vắc-xin này cũng sử dụng các chủng Eimeria đã bị làm yếu hoặc chết để tạo miễn dịch cho gà.
Công dụng: Đây là vắc-xin giúp tăng cường miễn dịch cho gà, giảm thiểu tình trạng nhiễm trùng nặng do cầu trùng gây ra, đồng thời tăng khả năng sinh sản và năng suất.
6.6. Vắc-xin Coccivac-B
Định nghĩa: Là một vắc-xin phòng bệnh cầu trùng, giúp bảo vệ gà khỏi các loại cầu trùng phổ biến.
Công dụng: Đây là loại vắc-xin phòng ngừa hiệu quả, đặc biệt đối với gà trong giai đoạn nuôi thương phẩm.
Lý do sử dụng vắc-xin:
Phòng ngừa hiệu quả: Vắc-xin giúp ngăn ngừa bệnh cầu trùng, giảm tỷ lệ nhiễm bệnh và thiệt hại kinh tế.
Tăng sức đề kháng: Sau khi tiêm vắc-xin, hệ miễn dịch của gà được kích thích để nhận diện và chống lại các chủng cầu trùng, giảm thiểu nguy cơ nhiễm bệnh.
...
2. Nguyên nhân gây bệnh thương hàn gà ?
Nguyên nhân gây bệnh thương hàn gà  là do vi khuẩn Salmonella gây ra. Vi khuẩn này là một loại vi khuẩn gram âm có thể xâm nhập vào cơ thể gà qua nhiều con đường khác nhau. Các nguyên nhân chủ yếu gây bệnh này bao gồm:
...
ALTER TABLE benh 
DROP COLUMN mo_ta_benh,
DROP COLUMN nguyen_nhan,
DROP COLUMN trieu_chung,
DROP COLUMN phong_benh,
DROP COLUMN dieu_tri_vac_xin;
